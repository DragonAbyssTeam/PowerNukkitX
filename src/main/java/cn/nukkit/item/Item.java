...
public class Item implements Cloneable, BlockID, ItemID {
    ...
    @PowerNukkitXOnly
    @Since("1.6.0.0-PNX")
    private static boolean checkIsNotEnableCustomItem(Class<? extends ItemCustom> c) {
    ...
    public static void registerCustomItem(Class<? extends ItemCustom> c) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        if (checkIsNotEnableCustomItem(c)) return;
        ItemCustom itemCustom = c.getDeclaredConstructor().newInstance();
        registerCustomItem(itemCustom);
    }

    @PowerNukkitXOnly
    @Since("1.6.0.0-PNX")
    public static void registerCustomItem(String namespaceId, String name, Class<? extends ItemCustom> c) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        if (checkIsNotEnableCustomItem(c)) return;
        ItemCustom itemCustom = c.getDeclaredConstructor(String.class, String.class).newInstance(namespaceId, name);
        registerCustomItem(itemCustom);
    }

    @PowerNukkitXOnly
    @Since("1.6.0.0-PNX")
    public static void registerCustomItem(String namespaceId, String name, String textureName, Class<? extends ItemCustom> c) throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        if (checkIsNotEnableCustomItem(c)) return;
        ItemCustom itemCustom = c.getDeclaredConstructor(String.class, String.class, String.class).newInstance(namespaceId, name, textureName);
        registerCustomItem(itemCustom);
    }
    ...
    @PowerNukkitXOnly
    @Since("1.6.0.0-PNX")
    public static boolean isCustomItem(Item item) {
        return CUSTOM_ITEMS.containsKey(item.getNamespaceId());
    }

    @PowerNukkitXOnly
    @Since("1.6.0.0-PNX")
    public static boolean isCustomItem(String namespaceId) {
        return CUSTOM_ITEMS.containsKey(namespaceId);
    }
